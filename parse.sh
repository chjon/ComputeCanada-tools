...
parse_maplesat() {
	...
	echo "${SOLVER_NAME},${PROBLEM},${RESTARTS},${CONFLICTS},${DECISIONS},${PROPAGATIONS},${CONF_LITS},${TOTAL_EXT_VARS},${DELETED_EXT_VARS},${EXT_DECISIONS},${CONF_EXT_CLAUSES},${LEARNT_EXT_CLAUSES},${LEARNT_LBD},${MEM_USED},${CPU_TIME},${ER0_TIME},${ER1_TIME},${ER2_TIME},${ER3_TIME},${ER4_TIME},${ER5_TIME},${SATISFIABILITY}"
}
...
elif [[ ${SOLVER_NAME} == glucoser* ]]; then
	PARSE_FUNCTION="parse_glucoser"
